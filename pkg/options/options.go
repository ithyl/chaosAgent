...
func (o *Options) AddFlags() {
	...
	o.Flags.StringVar(&o.LogConfig.Level, "log.level", "debug", "logging level: debug|info|warn|error|fatal|panic")
	...
	o.Flags.StringVar(&o.TransportConfig.Endpoint, "endpoint", "9432", "endpoint")
